    ...
    , ui(new Ui::search)
{
    ...
    ordersTable->setColumnCount(5); // عدد الأعمدة اللي هتعرضها (id, Address, Service, Price, Notes, Status)
    ordersTable->setHorizontalHeaderLabels({"ID", "number phone", "Service", "Price", "Notes"}); // أسماء الأعمدة
    ...
    fetchOrders();
    QMessageBox::information(this, "تنبيه ", "يرجى تدوير الشاشة لتنضيم افضل للمعلومات و الحصول على افضل تجربة ");
